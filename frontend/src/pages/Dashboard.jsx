    ...
    <Layout title="Dashboard">
      ...
      {loading ? (
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-10 text-center">
          ...
          <h3 className="text-base font-semibold text-gray-700 mb-2">No measurements yet</h3>
          <p className="text-sm text-gray-400 mb-6 max-w-xs mx-auto">
            Start logging your baby's weight, height, and more to see growth charts and AI insights here.
          </p>
          <div className="flex gap-3 justify-center flex-wrap">
            ...
            <button
              onClick={() => setShowBatch(true)}
              className="border border-blue-200 text-blue-600 hover:bg-blue-50 text-sm font-medium px-5 py-2.5 rounded-xl transition-colors"
            >
              ⊞ Batch Entry
            </button>
          </div>
